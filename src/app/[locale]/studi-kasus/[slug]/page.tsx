...
export default async function CaseStudyDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <PlaceholderImage label={caseStudy.title} hasImage={caseStudy.hasImage} imageSrc={caseStudy.imageUrl} illustrationCategory="case-study" className="h-56 w-full rounded-xl sm:h-72" />
