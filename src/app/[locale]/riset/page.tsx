...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "riset" });
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 rounded-xl border border-stone-200 bg-stone-50 p-6 sm:p-8">
        <h2 className="text-lg font-semibold text-stone-900">{t("proposeSection.title")}</h2>
        <p className="mt-1 max-w-2xl text-sm text-stone-500">{t("proposeSection.description")}</p>
        <div className="mt-6">
