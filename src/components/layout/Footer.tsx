    ...
    <footer className="mt-16 border-t border-stone-200 bg-stone-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            <p className="mb-3 text-sm font-semibold text-stone-800">Jelajahi</p>
          ...
          <div>
            <p className="mb-3 text-sm font-semibold text-stone-800">Direktori</p>
            <ul className="flex flex-col gap-2">
              <li>
                <Link href="/direktori" className="text-sm text-stone-500 hover:text-emerald-700">
                  Cari Produsen
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/sumber-daya" className="text-sm text-stone-500 hover:text-emerald-700">
                  Kalkulator & Unduhan
                </Link>
              </li>
            </ul>
